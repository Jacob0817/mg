...
setupTasks.push(
	...
	augment( Group, {
		...
		selectCubelet: function(){
			this.cubelets.forEach( function( cubelet ){ cubelet.selectCubelet() })
			return this
		},
		unselectCubelet: function(){
			this.cubelets.forEach( function( cubelet ){ cubelet.unselectCubelet() })
			return this
		},
		selectFace: function(){
			this.cubelets.forEach( function( cubelet ){ cubelet.selectFace() })
			return this
		},
		...
		getColor: function () {
			var colorset = []
			this.cubelets.forEach(function (cubelet) {
				colorset.push(cubelet.getColor())
			})
			return colorset
		},
		setColor:function (color_pos,value) {
			this.showStickers()
			this.cubelets.forEach(function (cubelet) {
				console.log('color_pos',color_pos,'value',value)
				cubelet.setColor(color_pos,value)
			})
		},
		resetColor:function () {
			this.cubelets.forEach(function (cubelet) {
