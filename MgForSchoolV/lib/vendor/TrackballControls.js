...
THREE.TrackballControls = function ( object, domElement ) {
    ...
    this.handleResize = function () {
        ...
        //这里有一个bug   当document不是dom的时候, 用getBoundingClientRect 会得到0
        ...
        //     console.log('[debug][this.domElement]',this.domElement)
        //     console.log('[debug][screen]',this.screen)
        //
        // }
    ...
    this.getMouseProjectionOnBall = function ( clientX, clientY ) {
        ...
        // console.log('[debug][mouseonball]',mouseOnBall)
    ...
    this.rotateCamera = function () {
        ...
        // console.log(_rotateStart,_rotateEnd,angle)
        if ( angle ) {
