    ...
    <v-layout row wrap>
      ...
      <v-flex xs12 md7 style="font-size:30px">
        ...
        >
          ...
          <v-stepper-content step="2">
            <v-card color="grey lighten-1" class="mb-1" height="350px">
              ...
              <div>
                ...
                <v-btn  class="cube-color"   color="red lighten-1">
                    第一步：找到花瓣
                </v-btn>
                <v-btn  class="cube-color" @click="cubetwist(``,false)" color="green lighten-1">
                    第二步：花瓣面对自己
                </v-btn>
                <v-btn  class="cube-color" @click="cubetwist(`R`,false)" color="blue lighten-1">
                    第三步：做动作“上”
                </v-btn>
                <br>
                ...
                <v-btn  class="cube-color" @click="cubetwist(`Y`,false)" color="green lighten-1">
                    花瓣面对自己
                </v-btn>
                ...
                <br>
                <v-btn @click="setCube1toc3()" class="cube-color" color="grey lighten-1">
                    情况3:
                </v-btn>
                <v-btn  class="cube-color"   color="red lighten-1">
                    找到花瓣
                ...
                <v-btn  class="cube-color" @click="cubetwist(`U'`,false)" color="blue lighten-1">
                    上方是灰色
                </v-btn>
                <v-btn  class="cube-color" @click="cubetwist(`R`,false)" color="yellow lighten-1">
                    做动作“上”
                </v-btn>
                <br>
                 <v-btn @click="setCube1toc4()" class="cube-color" color="grey lighten-1">
                    情况4:
                </v-btn>
                <v-btn  class="cube-color"   color="red lighten-1">
                    找到花瓣
                ...
                <v-btn  class="cube-color" @click="cubetwist(`F'`,false)" color="blue lighten-1">
                    花瓣移动到二楼
                </v-btn>
                <v-btn  class="cube-color" @click="cubetwist(`U'R`,false)" color="yellow lighten-1">
                    做二层方法
                </v-btn>
                <br>
                <v-btn @click="setCube1toc5()" class="cube-color" color="grey lighten-1">
                    情况5:
                </v-btn>
                <v-btn  class="cube-color"   color="red lighten-1">
                    找到花瓣
                ...
                <v-btn  class="cube-color" @click="cubetwist(`UF'`,false)" color="blue lighten-1">
                    花瓣移动到二楼
                </v-btn>
                <v-btn  class="cube-color" @click="cubetwist(`U'R`,false)" color="yellow lighten-1">
                    做二层方法
          ...
          <v-stepper-step color="purple lighten-1" :complete="stepSwithValue > 3" step="3">实例演示</v-stepper-step>

          <v-stepper-content step="3">
            <v-card color="grey lighten-1" row class="mb-1" height="300px">
              <v-layout justify-center row fill-height>
                <v-flex xs12 text-xs-left>
                  
                   <v-btn @click="setCube1tos1()" class="cube-color" color="grey lighten-1">
                    实例1:
                </v-btn>
                <br>
                ...
                <v-btn  class="cube-color" @click="cubetwist(`F'`,false)" color="yellow lighten-1">
                    移动到二层
                </v-btn>
                <v-btn  class="cube-color" @click="cubetwist(`U'R`,false)" color="blue lighten-1">
                    做二层方法
                </v-btn>
                     <br>
                <v-btn  class="cube-color" color="grey lighten-1">
                ...
                <v-btn  class="cube-color" @click="cubetwist(`X`,false)" color="green lighten-1">
                    花瓣面对自己
                </v-btn>
                <v-btn  class="cube-color" @click="cubetwist(`FX'FF`,false)" color="yellow lighten-1">
                    做二层方法
                </v-btn>
...
export default {
  ...
  data: () => ({
    ...
    formulaTest : {
      ...
      cubeStateBefore : classStateList.class2base,
      cubeStateOk : classStateList.class2ok,
      cubeStateMain : classStateList.class2base,
      cubeRunscript:{},
    }
  }),
  mounted: function() {
  ...
  methods: {
    ...
    resetCube1 :function(){
      this.formulaTest.cubeStateMain = classStateList.class2base
      this.stepcounter = 1
    ...
    setCube1toc2:function(){
        this.formulaTest.cubeStateMain = classStateList.class2c1
        this.cube.show = false
        this.$nextTick(() => {
                this.cube.show = true;//重建组件
            })
    ...
    setCube1toc3:function(){
        this.formulaTest.cubeStateMain = classStateList.class2c2
        this.cube.show = false
        this.$nextTick(() => {
                this.cube.show = true;//重建组件
            })
    ...
    setCube1toc4:function(){
        this.formulaTest.cubeStateMain = classStateList.class2c3
        this.cube.show = false
        this.$nextTick(() => {
                this.cube.show = true;//重建组件
            })
    },
    setCube1toc5:function(){
        this.formulaTest.cubeStateMain = classStateList.class2c4
        this.cube.show = false
        this.$nextTick(() => {
                this.cube.show = true;//重建组件
            })
    },
     setCube1tos1:function(){
        this.formulaTest.cubeStateMain = classStateList.class2s1
        this.cube.show = false
        this.$nextTick(() => {
                this.cube.show = true;//重建组件
            })
