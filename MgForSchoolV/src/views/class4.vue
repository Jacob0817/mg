          ...
          <v-stepper-content step="2">
            <v-card color="grey lighten-1" class="mb-1" height="350px">
              ...
              <div>
                ...
                <v-btn @click="cubetwist(``,false)" class="cube-color" color="orange lighten-1">
                    调整方向，对齐颜色面对自己
                </v-btn>
              ...
              <v-layout justify-center row fill-height>
                <v-flex xs12 text-xs-left>
                  ...
                  <v-divider light ></v-divider>
                    ...
                    <v-btn @click="cubetwist(`RUR'U'RUR'U'RUR'U'`,false)" class="cube-color" color="blue lighten-1">
                        右手动作*3次
                    </v-btn>
...
export default {
  ...
  data: () => ({
    ...
    formulaTest : {
      ...
      cubeStateBefore : classStateList.class4base,
      cubeStateOk : classStateList.class4ok,
      cubeStateMain : classStateList.class4base,
      cubeStateSp : classStateList.class4c1,
      cubeRunscript:{},
    }
  }),
  mounted: function() {
  ...
  methods: {
    ...
    resetCube1 :function(){
      this.formulaTest.cubeStateMain = classStateList.class4base
      this.stepcounter = 1
    ...
    setCube1toc2:function(){
        this.formulaTest.cubeStateMain = classStateList.class4c1
        this.cube.show = false
        this.$nextTick(() => {
                this.cube.show = true;//重建组件
            })
    ...
    setCube1toc3:function(){
        this.formulaTest.cubeStateMain = classStateList.class4c2
        this.cube.show = false
        this.$nextTick(() => {
                this.cube.show = true;//重建组件
            })
    ...
    setCube1toc4:function(){
        this.formulaTest.cubeStateMain = classStateList.class4c3
        this.cube.show = false
        this.$nextTick(() => {
                this.cube.show = true;//重建组件
            })
